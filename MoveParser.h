...
#include <sstream> // getMoveString
#include "Board.h"
class MoveParser{ //uses MoveInformation objects
        static std::string getMoveString(MoveInformation move) //creates a string from existing move characteristics
    {
        std::stringstream ss;
        ...
        static MoveInformation createMoveFromString(Board boardWaitingForMove, Color playerColor, std::string chessNotation){ //turn string into a move with rel attributes
        ...
        static MoveInformation parseMove(Color playerColor)
    {
        std::string lineArg;
